...
class AddGratitudeViewModel: ObservableObject {
    let responsible: [String] = [String(localized: "Family"), String(localized: "Friend"), String(localized: "Neighbour"), String(localized: "Workmate"), String(localized: "Me"), String(localized: "House Help"), String(localized: "Local Business"), String(localized: "Country"), String(localized: "Police"), String(localized: "Stranger"), String(localized: "Nobody"), String(localized: "Religion"), String(localized: "School"), String(localized: "Social Media"), String(localized: "Other")]
    let feel : [String] = ["😐","🫠","😊","😁","😍","🤗","🤣","🫢","🤨","😎","😉","😇","😮"]
